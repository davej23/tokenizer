...
test_tokens = t.tokenize(test_text)
decoded_test_tokens = t.untokenize(test_tokens)
...
print("Tokens: ", test_tokens, "Onehot token 1 indices: ", [n.index(1) for n in Tokenizer.onehot_encode(test_tokens, t.get_vocab())])
